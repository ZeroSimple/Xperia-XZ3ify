...
print_modname() {
  ui_print "*******************************"
  ui_print "         Xperia XZ3ify         "
  ui_print "*******************************"
  ui_print "Get XZ3 Apps for XZ1/XZ1 Compact/XZ1/XZ1 Premium. "
  ui_print "Feedbacks: hqf0327g@gmail.com"
}
...
/system/priv-app/PocketMode-release
/system/priv-app/RecallPlaybackPhotos-release
/system/priv-app/Settings
/system/priv-app/SettingsIntelligence
